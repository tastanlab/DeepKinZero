...
if __name__ == '__main__':
    ...
    parser.add_argument('--Test_haslabels', action='store_true', help='Testdata has labels')
    # Val data Paths
    ...
    if not os.path.isfile('RunWithBestMethod.csv'):
        ...
        #try:
    Train_Evaluations, Val_Evaluations, Test_Evaluations, PredKinUniProtIDs = Run(Model = 'ZSL', TrainingEpochs = 50,
        ...
        TrainData = args.TrainData, TestData = args.TestData, ValData=args.ValData, 
        TestKinaseCandidates= args.TestKinaseCandidates, TestisLabeled=args.Test_haslabels,
        ValKinaseCandidates= args.ValKinaseCandidates,
        ParentLogDir = 'RunWithBestModel', EmbeddingOrParams=True, CheckpointPath=args.BestModelCheckpoint)
    if args.Test_haslabels:
